...
public class ComplexDnD extends JFrame implements DragGestureListener {
     ...
     *
     */
    private static final long serialVersionUID = 1900236310755516544L;
    ...
    public void dragGestureRecognized(DragGestureEvent event) { //done
    ...
    private class MyDropTargetListener extends DropTargetAdapter { //done
    ...
    private void createLayout(JComponent... arg) {
        ...
        gl.setHorizontalGroup(gl.createSequentialGroup().addComponent(arg[0]).addGap(30).addComponent(arg[1]).addGap(30)
                .addComponent(arg[2]));
...
class TransferableColor implements Transferable { //done
